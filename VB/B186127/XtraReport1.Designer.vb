...
'			Me.AptDescriptionLabel.BeforePrint += New System.Drawing.Printing.PrintEventHandler(Me.AptDescriptionLabel_BeforePrint);
			' 
			' AptTimeLabel
			' 
...
'			Me.AptTimeLabel.BeforePrint += New System.Drawing.Printing.PrintEventHandler(Me.AptTimeLabel_BeforePrint);
			' 
			' TopMargin
			' 
